...
export const selectCitacionesLoading = (state) => state.citaciones.loading
export const selectCitacionesError = (state) => state.citaciones.error
export const selectSelectedCitacion = (state) => state.citaciones.selectedCitacion
...
export const selectCreateLoading = (state) => state.citaciones.createLoading
export const selectUpdateLoading = (state) => state.citaciones.updateLoading
export const selectDeleteLoading = (state) => state.citaciones.deleteLoading
export const selectAssignLoading = (state) => state.citaciones.assignLoading
export const selectAttendanceLoading = (state) => state.citaciones.attendanceLoading
