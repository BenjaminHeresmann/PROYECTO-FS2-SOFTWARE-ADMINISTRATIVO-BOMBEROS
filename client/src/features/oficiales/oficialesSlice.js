  ...
  extraReducers: (builder) => {
    ...
    builder
      ...
      .addCase(fetchOficiales.fulfilled, (state, action) => {
        ...
        state.oficiales = action.payload.data || []
        state.totalOficiales = action.payload.total || 0
    ...
    builder
      ...
      .addCase(fetchOficialById.fulfilled, (state, action) => {
        state.selectedOficial = action.payload.data
      })
    ...
    builder
      ...
      .addCase(createOficial.fulfilled, (state, action) => {
        state.oficiales.unshift(action.payload.data)
    ...
    builder
      ...
      .addCase(updateOficial.fulfilled, (state, action) => {
        const index = state.oficiales.findIndex(
          oficial => oficial.id === action.payload.data.id
        )
        if (index !== -1) {
          state.oficiales[index] = action.payload.data
        }
        if (state.selectedOficial?.id === action.payload.data.id) {
          state.selectedOficial = action.payload.data
        }
      })
    ...
    builder
      ...
      .addCase(fetchJerarquia.fulfilled, (state, action) => {
        ...
        state.jerarquia = action.payload.data || []
      })
    ...
    builder
      ...
      .addCase(fetchEstadisticas.fulfilled, (state, action) => {
        ...
        state.estadisticas = action.payload.data || initialState.estadisticas
      })
